      ...
      <section className="py-16 border-t border-border">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="aspect-video bg-gradient-to-br from-[#8B5CF6]/20 to-[#8B5CF6]/5 rounded-2xl"></div>
          </div>
        </div>
      </section>
      ...
      <section id="biblioteca" className="py-16 border-t border-border">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="border-l-4 pl-6" style={{ borderColor: "#8B5CF6" }}>
              ...
              <a href="#" className="text-sm font-medium" style={{ color: "#8B5CF6" }}>
                Explorar artigos →
              </a>
            </div>
